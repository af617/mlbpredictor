...
rewrite the whole code ( but only chang ethings related to these additions). Add pfx_x and pfx_z sliders, but they are automatically changed when the pitch changes using the league average. make sure to add the tooltips to them aswell. 
